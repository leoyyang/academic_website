...
summary: From 752.6 million Chinese job ads (2022–2026), we build standardized catalogs of 20,721 requirements and 44,479 tasks, separating rising requirements from changing tasks and reading the labor market month by month — showing, for example, that counting occupations versus tasks yields very different conclusions about language-model exposure.
